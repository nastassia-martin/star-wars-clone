...
const SpeciesPage = () => {
	...
	const getSpecies = async (searchQuery: string, searchPage = 1) => {
		...
		try {
			// make req
			const res = await StarWarsAPI.getAllSpecies(searchQuery, searchPage)
