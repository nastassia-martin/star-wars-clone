...
const StarshipsPage = () => {
    ...
    const getStarships = async (searchQuery: string, searchPage = 1) =>{
        ...
        try {
            // make req 
            const res = await StarWarsAPI.getAllStarships(searchQuery, searchPage) 
